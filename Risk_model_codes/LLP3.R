# LLP model V3 (based on: Field, Thorax, 2020)
# Author          Kevin ten Haaf
# Organization    Erasmus Medical Center Rotterdam
#Last adjusted: February 9 2021


#Note: Family history: 0 is no family history, 1 is early onset (age <60), 2 is late onset (age>=60)
model.LLP3 = function(Age,Smokingduration,Familyhistory,Personalhistory,Pneumonia,Asbestos,Gender)  
{
  ...
  Maleagecoeffs = c(-9.84,-8.94,-8.09,-7.41,-6.75,-6.34,-6.09,-5.61,-5.46)
  Femaleagecoeffs= c(-10.37,-8.53,-7.93,-6.97,-6.69,-6.46,-5.96,-5.70,-5.89)
